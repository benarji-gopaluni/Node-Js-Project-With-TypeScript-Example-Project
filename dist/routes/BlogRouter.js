...
class BlogRouter {
    ...
    initRoutes() {
        ...
        this._router.post(`${this.path}/addBlog`, new middleware_1.default().checkToken, this.addBlogItem);
        this._router.post(`${this.path}/listById`, this.listBlogById);
        this._router.post(`${this.path}/listByTopic`, this.listBlogsByTopic);
        this._router.put(`${this.path}/updateBlogById`, new middleware_1.default().checkToken, this.updateBlogById);
        this._router.delete(`${this.path}/deleteBlogById`, new middleware_1.default().checkToken, this.deleteBlogById);
    }
}
